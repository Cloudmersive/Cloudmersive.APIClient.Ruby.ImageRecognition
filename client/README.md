...
```shell
gem install ./cloudmersive-image-recognition-api-client-1.3.9.gem
```
(for development, run `gem install --dev ./cloudmersive-image-recognition-api-client-1.3.9.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cloudmersive-image-recognition-api-client', '~> 1.3.9'
