...
module CloudmersiveImageRecognitionApiClient
  ...
  class AgeDetectionResult
    ...
    def self.swagger_types
      {
        :'successful' => :'BOOLEAN',
        :'people_with_age' => :'Array<PersonWithAge>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PeopleWithAge')
        if (value = attributes[:'PeopleWithAge']).is_a?(Array)
          self.people_with_age = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          people_with_age == o.people_with_age &&
    ...
    def hash
      [successful, people_with_age, people_identified].hash
    end
